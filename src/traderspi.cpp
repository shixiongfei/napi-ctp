...
static const std::map<int, std::string> eventNames = {
  ...
  {ET_RSPAUTHENTICATE,                          "authenticate"},
  {ET_RSPUSERLOGIN,                             "user-login"},
  {ET_RSPUSERLOGOUT,                            "user-logout"},
  {ET_RSPUSERPASSWORDUPDATE,                    "user-password-update"},
  {ET_RSPTRADINGACCOUNTPASSWORDUPDATE,          "trading-account-password-update"},
  {ET_RSPUSERAUTHMETHOD,                        "user-auth-method"},
  {ET_RSPGENUSERCAPTCHA,                        "gen-user-captcha"},
  {ET_RSPGENUSERTEXT,                           "gen-user-text"},
  {ET_RSPORDERINSERT,                           "order-insert"},
  {ET_RSPPARKEDORDERINSERT,                     "parked-order-insert"},
  {ET_RSPPARKEDORDERACTION,                     "parked-order-action"},
  {ET_RSPORDERACTION,                           "order-action"},
  {ET_RSPQRYMAXORDERVOLUME,                     "qry-max-order-volume"},
  {ET_RSPSETTLEMENTINFOCONFIRM,                 "settlement-info-confirm"},
  {ET_RSPREMOVEPARKEDORDER,                     "remove-parked-order"},
  {ET_RSPREMOVEPARKEDORDERACTION,               "remove-parked-order-action"},
  {ET_RSPEXECORDERINSERT,                       "exec-order-insert"},
  {ET_RSPEXECORDERACTION,                       "exec-order-action"},
  {ET_RSPFORQUOTEINSERT,                        "for-quote-insert"},
  {ET_RSPQUOTEINSERT,                           "quote-insert"},
  {ET_RSPQUOTEACTION,                           "quote-action"},
  {ET_RSPBATCHORDERACTION,                      "batch-order-action"},
  {ET_RSPOPTIONSELFCLOSEINSERT,                 "option-self-close-insert"},
  {ET_RSPOPTIONSELFCLOSEACTION,                 "option-self-close-action"},
  {ET_RSPCOMBACTIONINSERT,                      "comb-action-insert"},
  {ET_RSPQRYORDER,                              "qry-order"},
  {ET_RSPQRYTRADE,                              "qry-trade"},
  {ET_RSPQRYINVESTORPOSITION,                   "qry-investor-position"},
  {ET_RSPQRYTRADINGACCOUNT,                     "qry-trading-account"},
  {ET_RSPQRYINVESTOR,                           "qry-investor"},
  {ET_RSPQRYTRADINGCODE,                        "qry-trading-code"},
  {ET_RSPQRYINSTRUMENTMARGINRATE,               "qry-instrument-margin-rate"},
  {ET_RSPQRYINSTRUMENTCOMMISSIONRATE,           "qry-instrument-commission-rate"},
  {ET_RSPQRYEXCHANGE,                           "qry-exchange"},
  {ET_RSPQRYPRODUCT,                            "qry-product"},
  {ET_RSPQRYINSTRUMENT,                         "qry-instrument"},
  {ET_RSPQRYDEPTHMARKETDATA,                    "qry-depth-market-data"},
  {ET_RSPQRYTRADEROFFER,                        "qry-trader-offer"},
  {ET_RSPQRYSETTLEMENTINFO,                     "qry-settlement-info"},
  {ET_RSPQRYTRANSFERBANK,                       "qry-transfer-bank"},
  {ET_RSPQRYINVESTORPOSITIONDETAIL,             "qry-investor-position-detail"},
  {ET_RSPQRYNOTICE,                             "qry-notice"},
  {ET_RSPQRYSETTLEMENTINFOCONFIRM,              "qry-settlement-info-confirm"},
  {ET_RSPQRYINVESTORPOSITIONCOMBINEDETAIL,      "qry-investor-position-combine-detail"},
  {ET_RSPQRYCFMMCTRADINGACCOUNTKEY,             "qry-cfmmc-trading-account-key"},
  {ET_RSPQRYEWARRANTOFFSET,                     "qry-e-warrant-offset"},
  {ET_RSPQRYINVESTORPRODUCTGROUPMARGIN,         "qry-investor-product-group-margin"},
  {ET_RSPQRYEXCHANGEMARGINRATE,                 "qry-exchange-margin-rate"},
  {ET_RSPQRYEXCHANGEMARGINRATEADJUST,           "qry-exchange-margin-rate-adjust"},
  {ET_RSPQRYEXCHANGERATE,                       "qry-exchange-rate"},
  {ET_RSPQRYSECAGENTACIDMAP,                    "qry-sec-agent-acid-map"},
  {ET_RSPQRYPRODUCTEXCHRATE,                    "qry-product-exch-rate"},
  {ET_RSPQRYPRODUCTGROUP,                       "qry-product-group"},
  {ET_RSPQRYMMINSTRUMENTCOMMISSIONRATE,         "qry-mm-instrument-commission-rate"},
  {ET_RSPQRYMMOPTIONINSTRCOMMRATE,              "qry-mm-option-instr-comm-rate"},
  {ET_RSPQRYINSTRUMENTORDERCOMMRATE,            "qry-instrument-order-comm-rate"},
  {ET_RSPQRYSECAGENTTRADINGACCOUNT,             "qry-sec-agent-trading-account"},
  {ET_RSPQRYSECAGENTCHECKMODE,                  "qry-sec-agent-check-mode"},
  {ET_RSPQRYSECAGENTTRADEINFO,                  "qry-sec-agent-trade-info"},
  {ET_RSPQRYOPTIONINSTRTRADECOST,               "qry-option-instr-trade-cost"},
  {ET_RSPQRYOPTIONINSTRCOMMRATE,                "qry-option-instr-comm-rate"},
  {ET_RSPQRYEXECORDER,                          "qry-exec-order"},
  {ET_RSPQRYFORQUOTE,                           "qry-for-quote"},
  {ET_RSPQRYQUOTE,                              "qry-quote"},
  {ET_RSPQRYOPTIONSELFCLOSE,                    "qry-option-self-close"},
  {ET_RSPQRYINVESTUNIT,                         "qry-invest-unit"},
  {ET_RSPQRYCOMBINSTRUMENTGUARD,                "qry-comb-instrument-guard"},
  {ET_RSPQRYCOMBACTION,                         "qry-comb-action"},
  {ET_RSPQRYTRANSFERSERIAL,                     "qry-transfer-serial"},
  {ET_RSPQRYACCOUNTREGISTER,                    "qry-account-register"},
  {ET_RSPERROR,                                 "error"},
  {ET_RTNORDER,                                 "order"},
  {ET_RTNTRADE,                                 "trade"},
  {ET_ERRRTNORDERINSERT,                        "err-order-insert"},
  {ET_ERRRTNORDERACTION,                        "err-order-action"},
  {ET_RTNINSTRUMENTSTATUS,                      "instrument-status"},
  {ET_RTNBULLETIN,                              "bulletin"},
  {ET_RTNTRADINGNOTICE,                         "trading-notice"},
  {ET_RTNERRORCONDITIONALORDER,                 "error-conditional-order"},
  {ET_RTNEXECORDER,                             "exec-order"},
  {ET_ERRRTNEXECORDERINSERT,                    "err-exec-order-insert"},
  {ET_ERRRTNEXECORDERACTION,                    "err-exec-order-action"},
  {ET_ERRRTNFORQUOTEINSERT,                     "err-for-quote-insert"},
  {ET_RTNQUOTE,                                 "quote"},
  {ET_ERRRTNQUOTEINSERT,                        "err-quote-insert"},
  {ET_ERRRTNQUOTEACTION,                        "err-quote-action"},
  {ET_RTNFORQUOTERSP,                           "for-quote"},
  {ET_RTNCFMMCTRADINGACCOUNTTOKEN,              "cfmmc-trading-account-token"},
  {ET_ERRRTNBATCHORDERACTION,                   "err-batch-order-action"},
  {ET_RTNOPTIONSELFCLOSE,                       "option-self-close"},
  {ET_ERRRTNOPTIONSELFCLOSEINSERT,              "err-option-self-close-insert"},
  {ET_ERRRTNOPTIONSELFCLOSEACTION,              "err-option-self-close-action"},
  {ET_RTNCOMBACTION,                            "comb-action"},
  {ET_ERRRTNCOMBACTIONINSERT,                   "err-comb-action-insert"},
  {ET_RSPQRYCONTRACTBANK,                       "qry-contract-bank"},
  {ET_RSPQRYPARKEDORDER,                        "qry-parked-order"},
  {ET_RSPQRYPARKEDORDERACTION,                  "qry-parked-order-action"},
  {ET_RSPQRYTRADINGNOTICE,                      "qry-trading-notice"},
  {ET_RSPQRYBROKERTRADINGPARAMS,                "qry-broker-trading-params"},
  {ET_RSPQRYBROKERTRADINGALGOS,                 "qry-broker-trading-algos"},
  {ET_RSPQUERYCFMMCTRADINGACCOUNTTOKEN,         "query-cfmmc-trading-account-token"},
  {ET_RTNFROMBANKTOFUTUREBYBANK,                "from-bank-to-future-by-bank"},
  {ET_RTNFROMFUTURETOBANKBYBANK,                "from-future-to-bank-by-bank"},
  {ET_RTNREPEALFROMBANKTOFUTUREBYBANK,          "repeal-from-bank-to-future-by-bank"},
  {ET_RTNREPEALFROMFUTURETOBANKBYBANK,          "repeal-from-future-to-bank-by-bank"},
  {ET_RTNFROMBANKTOFUTUREBYFUTURE,              "from-bank-to-future-by-future"},
  {ET_RTNFROMFUTURETOBANKBYFUTURE,              "from-future-to-bank-by-future"},
  {ET_RTNREPEALFROMBANKTOFUTUREBYFUTUREMANUAL,  "repeal-from-bank-to-future-by-future-manual"},
  {ET_RTNREPEALFROMFUTURETOBANKBYFUTUREMANUAL,  "repeal-from-future-to-bank-by-future-manual"},
  {ET_RTNQUERYBANKBALANCEBYFUTURE,              "query-bank-balance-by-future"},
  {ET_ERRRTNBANKTOFUTUREBYFUTURE,               "err-bank-to-future-by-future"},
  {ET_ERRRTNFUTURETOBANKBYFUTURE,               "err-future-to-bank-by-future"},
  {ET_ERRRTNREPEALBANKTOFUTUREBYFUTUREMANUAL,   "err-repeal-bank-to-future-by-future-manual"},
  {ET_ERRRTNREPEALFUTURETOBANKBYFUTUREMANUAL,   "err-repeal-future-to-bank-by-future-manual"},
  {ET_ERRRTNQUERYBANKBALANCEBYFUTURE,           "err-query-bank-balance-by-future"},
  {ET_RTNREPEALFROMBANKTOFUTUREBYFUTURE,        "repeal-from-bank-to-future-by-future"},
  {ET_RTNREPEALFROMFUTURETOBANKBYFUTURE,        "repeal-from-future-to-bank-by-future"},
  {ET_RSPFROMBANKTOFUTUREBYFUTURE,              "from-bank-to-future-by-future"},
  {ET_RSPFROMFUTURETOBANKBYFUTURE,              "from-future-to-bank-by-future"},
  {ET_RSPQUERYBANKACCOUNTMONEYBYFUTURE,         "query-bank-account-money-by-future"},
  {ET_RTNOPENACCOUNTBYBANK,                     "open-account-by-bank"},
  {ET_RTNCANCELACCOUNTBYBANK,                   "cancel-account-by-bank"},
  {ET_RTNCHANGEACCOUNTBYBANK,                   "change-account-by-bank"},
  {ET_RSPQRYCLASSIFIEDINSTRUMENT,               "qry-classified-instrument"},
  {ET_RSPQRYCOMBPROMOTIONPARAM,                 "qry-comb-promotion-param"},
  {ET_RSPQRYRISKSETTLEINVSTPOSITION,            "qry-risk-settle-invst-position"},
  {ET_RSPQRYRISKSETTLEPRODUCTSTATUS,            "qry-risk-settle-product-status"},
};
