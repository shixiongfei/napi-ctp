...
static const std::map<int, std::string> eventNames = {
  ...
  {ET_ERRRTNORDERINSERT,                        "errrtn-order-insert"},
  {ET_ERRRTNORDERACTION,                        "errrtn-order-action"},
  ...
  {ET_ERRRTNEXECORDERINSERT,                    "errrtn-exec-order-insert"},
  {ET_ERRRTNEXECORDERACTION,                    "errrtn-exec-order-action"},
  {ET_ERRRTNFORQUOTEINSERT,                     "errrtn-for-quote-insert"},
  {ET_RTNQUOTE,                                 "rtn-quote"},
  {ET_ERRRTNQUOTEINSERT,                        "errrtn-quote-insert"},
  {ET_ERRRTNQUOTEACTION,                        "errrtn-quote-action"},
  {ET_RTNFORQUOTERSP,                           "rtn-for-quote"},
  {ET_RTNCFMMCTRADINGACCOUNTTOKEN,              "rtn-cfmmc-trading-account-token"},
  {ET_ERRRTNBATCHORDERACTION,                   "errrtn-batch-order-action"},
  {ET_RTNOPTIONSELFCLOSE,                       "rtn-option-self-close"},
  {ET_ERRRTNOPTIONSELFCLOSEINSERT,              "errrtn-option-self-close-insert"},
  {ET_ERRRTNOPTIONSELFCLOSEACTION,              "errrtn-option-self-close-action"},
  {ET_RTNCOMBACTION,                            "rtn-comb-action"},
  {ET_ERRRTNCOMBACTIONINSERT,                   "errrtn-comb-action-insert"},
  ...
  {ET_ERRRTNBANKTOFUTUREBYFUTURE,               "errrtn-bank-to-future-by-future"},
  {ET_ERRRTNFUTURETOBANKBYFUTURE,               "errrtn-future-to-bank-by-future"},
  {ET_ERRRTNREPEALBANKTOFUTUREBYFUTUREMANUAL,   "errrtn-repeal-bank-to-future-by-future-manual"},
  {ET_ERRRTNREPEALFUTURETOBANKBYFUTUREMANUAL,   "errrtn-repeal-future-to-bank-by-future-manual"},
  {ET_ERRRTNQUERYBANKBALANCEBYFUTURE,           "errrtn-query-bank-balance-by-future"},
