...
napi_status msgFrontConnected(napi_env env, const Message *message,
                              napi_value *result) {
  return napi_get_undefined(env, result);
}

napi_status msgFrontDisconnected(napi_env env, const Message *message,
                                 napi_value *result) {
  return napi_create_int32(env, (int32_t)message->data, result);
}

napi_status msgHeartBeatWarning(napi_env env, const Message *message,
                                napi_value *result) {
  return napi_create_int32(env, (int32_t)message->data, result);
}

napi_status msgUserLogin(napi_env env, const Message *message,
                         napi_value *result) {
  napi_status status;
...
napi_status msgUserLogout(napi_env env, const Message *message,
                          napi_value *result) {
  napi_status status;
...
napi_status msgQryMulticastInstrument(napi_env env, const Message *message,
                                      napi_value *result) {
  napi_status status;
  auto pMulticastInstrument =
      MessageData<CThostFtdcMulticastInstrumentField>(message);
...
napi_status msgSubMarketData(napi_env env, const Message *message,
                             napi_value *result) {
  napi_status status;
  auto pSpecificInstrument =
      MessageData<CThostFtdcSpecificInstrumentField>(message);
...
napi_status msgUnSubMarketData(napi_env env, const Message *message,
                               napi_value *result) {
  napi_status status;
  auto pSpecificInstrument =
      MessageData<CThostFtdcSpecificInstrumentField>(message);
...
napi_status msgSubForQuote(napi_env env, const Message *message,
                           napi_value *result) {
  napi_status status;
  auto pSpecificInstrument =
      MessageData<CThostFtdcSpecificInstrumentField>(message);
...
napi_status msgUnSubForQuote(napi_env env, const Message *message,
                             napi_value *result) {
  napi_status status;
  auto pSpecificInstrument =
      MessageData<CThostFtdcSpecificInstrumentField>(message);
...
napi_status msgDepthMarketData(napi_env env, const Message *message,
                               napi_value *result) {
  napi_status status;
...
napi_status msgForQuote(napi_env env, const Message *message,
                        napi_value *result) {
  napi_status status;
...
static const std::map<int, MessageValueFunc> messageFuncs = {
    {EM_QUIT, msgQuit},
...
napi_status getMarketDataMessageValue(napi_env env, const Message *message,
  ...
  MessageValueFunc msgFunc = iter->second;
